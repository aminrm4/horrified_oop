...
void Fortune_Teller::event(perk * p,hero* hero, monster *m,std::vector<std::vector<int>>& map,std::vector<location*>& loc)
{
    loc[18]->set_villager(new villager("maleva" ,loc[5],loc[18]));
}
