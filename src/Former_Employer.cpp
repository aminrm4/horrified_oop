...
void Former_Employer::event(perk * p,hero* hero, monster *m,std::vector<std::vector<int>>& map,std::vector<location*>& loc)
{
    loc[4]->set_villager(new villager("Dr.cranly",loc[14] ,loc[4]));
