...
void Hurried_Assistant::event(perk * p,hero* hero, monster *m,std::vector<std::vector<int>>& map,std::vector<location*>& loc)
{
    loc[15]->set_villager(new villager("Fritz" ,loc[3] ,loc[15]));
}
